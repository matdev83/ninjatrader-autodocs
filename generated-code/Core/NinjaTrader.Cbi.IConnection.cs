namespace NinjaTrader.Cbi
{
    public partial interface IConnection
    {
        ...
        public void CreateAccount(string name, string displayName, string fcm, Currency denomination, int forexLotSize, System.Action<NinjaTrader.Cbi.Account, ErrorCode, string, object> callback, object state);
        /// <summary>
