...
{
    public partial class ConnectionProxy : IConnection
    {
        #region Properties
        /// <summary>
        ...
        public Void ExecutionUpdateCallback(Account account, Instrument instrument, String executionId, Exchange exchange, DateTime time, MarketPosition marketPosition, String orderId, Int32 quantity, Double price, Double commission, Double fee, Boolean isSod, DateTime statementDate, Operation operation);
        /// <summary>
        ...
        /// </summary>
        /// <param name="time">DateTime</param>
        public Void TimerCallback(DateTime time);
        /// <summary>
        ...
        /// <param name="args">Object</param>
        public Void TraceCallback(Func<Object, String> func, Object args);
        #endregion
    }
}
