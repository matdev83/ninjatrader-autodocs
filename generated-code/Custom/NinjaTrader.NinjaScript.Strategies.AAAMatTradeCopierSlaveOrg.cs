...
{
    public partial class AAAMatTradeCopierSlaveOrg : Strategy
    {
        #region Properties
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public Int32 ContractMultiplier { get; set; }
        /// <summary>
        ...
        #region Methods
        /// <summary>
        /// TradeCopierStep method.
        /// </summary>
        /// <param name="price">Object</param>
        public Void TradeCopierStep(Object price);
        #endregion
    }
}
